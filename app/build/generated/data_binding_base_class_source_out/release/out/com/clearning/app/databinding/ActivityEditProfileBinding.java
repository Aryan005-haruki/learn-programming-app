...
public final class ActivityEditProfileBinding implements ViewBinding {
  ...
  private ActivityEditProfileBinding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
      @NonNull Button btnSave, @NonNull EditText etEmail, @NonNull EditText etName,
      @NonNull EditText etPhone, @NonNull Toolbar toolbar) {
  ...
  public static ActivityEditProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditProfileBinding((LinearLayout) rootView, btnCancel, btnSave, etEmail,
          etName, etPhone, toolbar);
    }
