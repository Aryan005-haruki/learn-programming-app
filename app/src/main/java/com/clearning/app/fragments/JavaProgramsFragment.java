...
import com.clearning.app.utils.JavaProgramDataProvider;
import java.util.List;

public class JavaProgramsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2)); // 2 columns like C Programming
    ...
    private void setupCategories() {
        List<String> categories = JavaProgramDataProvider.getAllCategories();
    ...
    private class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder> {
        ...
        public void onBindViewHolder(@NonNull CategoryViewHolder holder, int position) {
            ...
            int programCount = JavaProgramDataProvider.getProgramsByCategory(category).size();
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("is_java", true); // Flag for Java programs
